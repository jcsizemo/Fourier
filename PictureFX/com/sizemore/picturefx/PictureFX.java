...
public class PictureFX {
	...
	private PictureFX() {
		int kernelWidth = 3;
		int kernelHeight = 3;
		float[] kernelData = {-1,-1,-1,-1,12,-1,-1,-1,-1};
		Kernel k = new Kernel(kernelWidth, kernelHeight, kernelData);
		String path = "/Users/John/Desktop/loveseatfixed.png";
		...
		ConvolveImage.printImage(image, "/Users/John/Desktop/loveseatfixed.png");
